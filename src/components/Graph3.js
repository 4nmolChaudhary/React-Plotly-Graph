...
function Graph3() {
	...
	useEffect(() => {
		;(async () => {
			const response = await axios.get(`http://192.168.1.51:9090/api/v1/query?query=ifHCInOctets%7BifDescr=%22FastEthernet0/0%22,instance=%2210.1.1.1%22,job=%22snmp%22%7D[60d]`)
			...
			const trace1 = { type: 'scatter', mode: 'lines', name: 'ifSpeed', x: dates, y: values, line: { color: '#7F7F7F' } }
